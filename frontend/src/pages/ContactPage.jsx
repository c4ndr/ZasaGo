          ...
          {CONTACTS.map(c => (
            ...
            >
              <div style={{ background: 'var(--k-card)', borderRadius: 16, padding: '16px', border: '1px solid var(--k-border)', display: 'flex', alignItems: 'center', gap: 14, transition: 'opacity 0.15s' }}>
                <div style={{ width: 48, height: 48, borderRadius: 14, background: `rgba(${c.rgb},0.1)`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, flexShrink: 0 }}>{c.icon}</div>
