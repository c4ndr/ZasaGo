...
function LocationPicker({ label, color, lat, lng, address, onchange }) {
  ...
  return (
    <div style={{ background: 'var(--k-card)', border: '1px solid var(--k-border)', borderRadius: 20, overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px 10px' }}>
        ...
        <button type="button" onClick={detectLocation} disabled={locating}
          style={{
            ...
            color: 'var(--k-accent)', border: '1px solid rgba(var(--k-accent-rgb),0.25)',
      ...
      {gpsError && (
        <div style={{ margin: '0 12px 8px', padding: '9px 12px', borderRadius: 10, background: 'rgba(var(--k-warn-rgb),0.08)', border: '1px solid rgba(var(--k-warn-rgb),0.25)', display: 'flex', gap: 8, alignItems: 'flex-start' }}>
    ...
    <div style={{ minHeight: '100dvh', background: 'var(--k-bg)', paddingBottom: 32 }}>
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '20px 16px' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ background: 'var(--k-card)', border: '1px solid var(--k-border)', borderRadius: 20, padding: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <div>
                ...
                {catError ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', borderRadius: 12, background: 'rgba(var(--k-danger-rgb),0.07)', border: '1px solid rgba(var(--k-danger-rgb),0.2)' }}>
              ...
              {(selectedCat?.requires_disclaimer || Number(form.item_value) > 200000) && (
                <div style={{ background: 'rgba(var(--k-warn-rgb),0.08)', border: '1px solid rgba(var(--k-warn-rgb),0.2)', borderRadius: 14, padding: '12px 14px' }}>
          ...
          <div style={{ background: 'var(--k-card)', border: '1px solid var(--k-border)', borderRadius: 20, padding: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div>
                ...
                {estimate ? (
                  <div style={{ background: 'var(--k-glow)', border: '1px solid rgba(var(--k-accent-rgb),0.3)', borderRadius: 14, padding: '14px 16px' }}>
              ...
              {promo.discountAmount > 0 && (
                <div style={{ background: 'rgba(var(--k-accent-rgb),0.06)', border: '1px solid rgba(var(--k-accent-rgb),0.2)', borderRadius: 14, padding: '10px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: 14, cursor: 'pointer', background: form.is_jastip_enabled ? 'rgba(var(--k-accent-rgb),0.06)' : 'var(--k-card)', border: `1.5px solid ${form.is_jastip_enabled ? 'var(--k-accent)' : 'var(--k-border)'}`, borderRadius: 20, padding: '14px 16px', transition: 'all 0.2s' }}>
          ...
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: 14, cursor: 'pointer', background: form.require_photo ? 'rgba(var(--k-accent-rgb),0.06)' : 'var(--k-card)', border: `1.5px solid ${form.require_photo ? 'var(--k-accent)' : 'var(--k-border)'}`, borderRadius: 20, padding: '14px 16px', transition: 'all 0.2s' }}>
            <div style={{ paddingTop: 2 }}>
